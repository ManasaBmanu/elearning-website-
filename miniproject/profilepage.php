...
<body>
	<div class="container-fluid" style="height:100px ">
		<div>
			<h1 class="col-sm-6 col-lg-9" style="top:25%; "><strong><em>E-Learning</strong></em></h1>
		</div>
		<div class="col-sm-6 col-lg-3" style="position:relative; top:25%; right:5%; ">
			<button id="course" type="button" style=" float:right; margin-right:10px " class="btn btn-lg btn-success">course</button>		</div>
		</div>
		<div class="container">
			<div class="panel panel-default" style="background-color:#FFFF;">
				...
				<div class="panel-boby">
					<img id="profilepic"  src="/miniproject/img/IMG-20171101-WA0043.jpg"
