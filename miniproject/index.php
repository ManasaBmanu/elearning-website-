...
<body>
    ...
    <div  class="" style="width:100%; height:400px">
        <img style="width:100%; height:400px" src="elearning.jpg">
...
<div class="mySlides">
  <q>Debugging is twice as hard as writing the code in the first place. Therefore, if you write the code as cleverly as possible, you are, by definition, not smart enough to debug it</q>
  <p class="author">- Brian Kernighan</p>
</div>
...
<div class="mySlides">
  <q>The first 90% of the code accounts for the first 90% of the development time. The remaining 10% of the code accounts for the other 90% of the development time.</q>
...
<div class="navbar">
  <a href="\miniproject\page_about.html"><button id="about" type="button" style=" float:right; display:none;" class="btn btn-lg btn-warning"></button>About</a>
	
	<a href="\miniproject\page_contact.html"><button id="about" type="button" style=" float:right; display:none;" class="btn btn-lg btn-warning"></button>Contact</a>
